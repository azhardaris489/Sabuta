...
<div class="flex basis-1/2 sm:basis-1/3 lg:basis-full sm:px-2 lg:px-4 mt-7">
    <div class="hidden lg:block flex-none lg:w-10 lg:mr-3 xl:mr-8 lg:pb-7">
        <div class="h-full grid grid-cols-1 lg:content-center">
            <h3 class="font-montserrat font-extrabold text-xl"><?php echo $row."."; ?></h3>
        </div>
    </div>
    <?php $row += 1; ?>
    <div class="flex-grow px-3 py-2 lg:pb-7 lg:pt-0 lg:mx-0 rounded-md lg:rounded-none border-2 lg:border-t-0 lg:border-l-0 lg:border-r-0 lg:border-b-2 border-gray-200">
        <div class="flex flex-col lg:flex-row">
            <div class="overflow-hidden rounded-lg border-2 border-gray-200 h-28 w-full lg:w-64 md:h-36 flex justify-center items-center">
                <img class="object-cover" src="<?php echo "upload/".$data['gambar']; ?>" alt="Foto Nama Pengguna">
            </div>
            <div class="lg:ml-10">
                <h2 class="font-semibold text-sm sm:text-base lg:text-xl mb-2 mt-3 lg:mt-0"><?php echo $data['nama']; ?></h2>
                <div class="border-l-2 border-blue-700">
                    <p class="text-xs lg:text-sm px-1.5 py-0.5"><?php echo $data['keperluan']; ?></p>
                </div>
                <div class="mt-3 hidden lg:block">
                    <div class="flex flex-col lg:flex-row mb-0.5">
                        <div class="lg:w-64">
                            ...
                            <span class="text-xs md:text-sm ml-1 md:ml-2"><?php echo $data['pekerjaan']; ?></span>
                        </div>
                        <div class="lg:w-64">
                            <i class="fa-solid fa-square-phone text-xs lg:text-base"></i>
                            <span class="text-xs md:text-sm ml-1 md:ml-2"><?php echo $data['no_hp']; ?></span>
                        </div>
                    </div>
                    <div class="flex flex-col lg:flex-row mb-0.5">
                        <div class="lg:w-64">
                            <i class="fa-solid fa-building text-xs lg:text-base"></i>
                            <span class="text-xs md:text-sm ml-1 md:ml-2"><?php echo $data['instansi']; ?></span>
                        </div>
                        <div class="lg:w-64">
                            <i class="fa-solid fa-envelope text-xs lg:text-base"></i>
                            <span class="text-xs md:text-sm ml-1 md:ml-2"><?php echo $data['email']; ?></span>
                        </div>
                    </div>
                    <div class="lg:w-auto">
                        <i class="fa-solid fa-location-dot text-xs lg:text-base"></i>
                        <span class="text-xs md:text-sm ml-1 md:ml-2"><?php echo $data['alamat']; ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="hidden lg:block flex-none w-10 ml-2 pb-7">
        <div class="h-full grid grid-cols-1 content-center">
            ...
            <p class="hidden" id="<?php echo "id_data_".$data['id']; ?>"></p>
        </div>
    </div>
</div>
...
<div class="flex justify-center mt-6">
    ...
    <?php
        ...
        $curr_html = "<li class='mx-4 font-semibold text-base'>".$page."</li>";
        ...
        echo $prev_html.$curr_html.$next_html;
    ?>
